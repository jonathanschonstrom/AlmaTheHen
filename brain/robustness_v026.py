"""Extended multi-seed robustness runner for BirdAI NeuralBrain v0.2.6."""
...
def main() -> int:
    ...
    parser.add_argument("--out", default="data/neural-robustness-v0.2.6.json")
    ...
    report = {
        "diagnostic": "BirdAI v0.5.6 NeuralBrain v0.2.6 physical-domain EXPLORE decoder robustness",
        "status": "PASS" if qualified else "FAIL",
        "qualified": qualified,
        "candidate_change": "scale_eval_points=False on all four EXPLORE function decoders; policy/BG/commitment/MANIPULATE unchanged",
        "seeds": list(SEEDS),
        "checks_per_seed": 21,
    ...
    print(f"NeuralBrain v0.2.6 extended robustness: {report['status']}")
